...
This is **bold**, *italic*, and includes a [link](https://example.com).

- Item 1
- Item 2
- Item 3

<em>Custom formatting</em> with <span style="color:red;">red text</span>.

Mixed **Markdown** and <u>HTML underline</u>.
